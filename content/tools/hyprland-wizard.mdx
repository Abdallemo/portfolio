...
### Why I made this
I wanted a way to get a functional Hyprland desktop with just one command. <s>I use both Arch and Ubuntu</s> I use Arch, so I made sure the script can detect which one you're on and install the right packages.
