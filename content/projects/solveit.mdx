...
This project started as a university assignment, but I wanted to build something I’d actually use. I noticed that most students use WhatsApp or Discord to find academic help, but it’s hard to track tasks and payments aren’t always secure. I wanted a way to make mentoring a more professional and safe experience for everyone.
