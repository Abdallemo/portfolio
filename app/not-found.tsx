...
import { AlertCircle, ArrowLeft, Home, Terminal as TerminalIcon } from "lucide-react";
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-20 h-[70vh] flex flex-col justify-center items-center font-mono">
      <div className="w-full max-w-md space-y-8">
        {/* Error Header */}
        <div className="border border-border p-6 bg-card-bg/50 space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              The requested memory address or resource could not be located in the current workspace. The link may be broken or the page has been de-indexed.
            </p>
          </div>
          ...
          <div className="pt-4 border-t border-border space-y-2">
            <div className="flex justify-between text-[10px]">
              ...
              <span className="text-destructive font-bold uppercase">Terminated</span>
            </div>
            <div className="flex justify-between text-[10px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            href="/"
            className="flex items-center justify-center gap-3 p-4 border border-border hover:border-accent hover:bg-card-bg transition-all group"
          >
          ...
          <Link
            ...
            className="flex items-center justify-center gap-3 p-4 border border-border hover:border-accent hover:bg-card-bg transition-all group"
          >
            <TerminalIcon size={16} className="text-dim group-hover:text-accent" />
            <span className="text-xs font-bold uppercase tracking-widest text-muted-foreground group-hover:text-foreground">
              Workbench
            </span>
          </Link>
